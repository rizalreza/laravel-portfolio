...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>
            <?php echo $__env->yieldContent('title','rizalreza'); ?>
        </title>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('dist/css/footer.css')); ?>"/>
        <script src="<?php echo e(asset('dist/css/bootstrap.min.js')); ?>"></script>
        <script src="<?php echo e(asset('dist/css/jquery-1.10.2.js')); ?>"></script>
  ...
  <div class="container ">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="<?php echo e(route('posts')); ?>">Portfolio</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo e(route('admin.index')); ?>">Login</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
